locals {
  names = {
    ...
    policy-assignment                   = lower("PA-${var.env}-${var.location_map[var.location]}-${var.application}")
    policy-definition                   = lower("PL-${var.env}-${var.location_map[var.location]}-${var.application}")
