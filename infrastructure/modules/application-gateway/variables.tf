...
variable "monitor_diagnostic_setting_application_gateway_enabled_logs" {
  type        = list(string)
  description = "Controls what logs will be enabled for the application gateway"
  default     = []
}

variable "monitor_diagnostic_setting_application_gateway_metrics" {
  type        = list(string)
  description = "Controls what metrics will be enabled for the application gateway"
  default     = []
}

variable "metric_enabled" {
  type        = bool
  description = "to enable retention for diagnostic settings metric for the application gateway"
  default     = true
}

variable "enable_alerting" {
  description = "Whether monitoring and alerting is enabled for the application gateway"
  type        = bool
  default     = false
}
...
variable "resource_group_name_monitoring" {
  type        = string
  description = "The name of the resource group in which to create the Monitoring resources for the application gateway. Changing this forces a new resource to be created."
  default     = null
}
