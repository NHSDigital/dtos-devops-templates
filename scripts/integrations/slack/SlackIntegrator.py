...
def main(argv):
    ...
    if args.verbose:
        print(f"[VERBOSE] Report Path: {args.report_path}")
        print(f"[VERBOSE] Success flag: {args.success}")
        print(f"[VERBOSE] Deployment Date: {args.deploy_date}")
        print(f"[VERBOSE] Deployment ID: {args.deploy_id}")
        print(f"[VERBOSE] Deployed By: {args.deploy_user}")
    ...
    test_results = parse_junit_results(args.report_path)
