...
resource "azurerm_dns_cname_record" "challenge_redirect" {
  ...
  name                = trim("_acme-challenge.${replace(replace(var.certificate.common_name, "*.", ""), ".${var.certificate.dns_cname_zone_name}", "")}", ".")
...
resource "azurerm_private_dns_cname_record" "challenge_redirect_private" {
  ...
  name                = trim("_acme-challenge.${replace(replace(var.certificate.common_name, "*.", ""), ".${var.certificate.dns_private_cname_zone_name}", "")}", ".")
