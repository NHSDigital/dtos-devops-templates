locals {
  names = {
    ...
    policy-assignment                   = lower("POLA-${var.env}-${var.location_map[va.location]}-${var.application}")
    policy-definition                   = lower("POL-${var.env}-${var.location_map[va.location]}-${var.application}")
